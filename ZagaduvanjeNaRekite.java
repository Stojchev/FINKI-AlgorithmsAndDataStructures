...
//
//
//public class ZagaduvanjeNaRekite {
//
...
//        Hashtable<Integer,String> hashReverse=new Hashtable<Integer,String>();
//        line=br.readLine().split(" ");
//        Graph<String>g=new Graph<String>(n+1,line);
//        for(int i=0;i<n+1;i++){
//            hash.put(line[i],i);
//            hashReverse.put(i,line[i]);
//        }
//        for(int i=0;i<n+1;i++){
//            line=br.readLine().split(" ");
//            g.addEdge(hash.get(line[0]),hash.get(line[1]),Integer.parseInt(line[2]));
//        }
//        line=br.readLine().split(" ");
//        String start=line[0];
//        int max=Integer.parseInt(line[1]);
//        int find=hash.get(start);
//        float dijkstra[]=g.dijkstra(find);
//        for(int i=0;i<dijkstra.length;i++){
//            if(dijkstra[i]>-1&&dijkstra[i]<max)
//                System.out.println(hashReverse.get(i));
//        }
//    }
//}
