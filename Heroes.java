...
//        SLLNode<Card> nodeFirst= firstFriendCards.getFirst();
//        SLLNode<Card> tmp= firstFriendCards.getFirst();
//        int max=0;
//        while(nodeFirst.succ!=null){
//            if(max<nodeFirst.succ.element.damage()*nodeFirst.succ.element.getNumAttacks()){
//                max=nodeFirst.element.damage()*nodeFirst.element.getNumAttacks();
//                tmp=nodeFirst;
//            }
//            nodeFirst=nodeFirst.succ;
//        }
////        firstFriendCards.delete(tmp);
//        SLLNode<Card> flag= tmp.succ;
//        if(tmp.succ!=null)
//            tmp.succ=tmp.succ.succ;
//        else tmp.succ=null;
//
//        nodeFirst= secondFriendCards.getFirst();
//        secondFriendCards.insertAfter(flag.element,nodeFirst.succ.succ);
////        SLLNode<Card>nodeSecond= secondFriendCards.getFirst();
////        for(int i=0;i<2;i++){
////            nodeSecond=nodeSecond.succ;
////        }
////        nodeSecond.succ.element=flag.element;
////        flag.succ.element=nodeSecond.succ.element;
