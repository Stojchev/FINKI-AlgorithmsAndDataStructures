...
//        HashMap<Integer, String> hashReverse = new HashMap<Integer, String>();
//        int k = 0;
//        for (int i = 0; i < n; i++) {
//            String iminja[] = br.readLine().split(" ");
//            String ime1 = iminja[0];
//            String ime2 = iminja[1];
//            if (!hash.containsKey(ime1)) {
//                hash.put(ime1,k);
//                hashReverse.put(k, ime1);
//                g.adjList[k++].setInfo(ime1);
//            }
//            if (!hash.containsKey(ime2)) {
//                hash.put(ime2, k);
//                hashReverse.put(k, ime2);
//                g.adjList[k++].setInfo(ime2);
//            }
//            g.addEdge(hash.get(ime1), hash.get(ime2), 1);
//        }
//        String name = br.readLine();
//        float dijkstra[]= g.dijkstra(hash.get(name));
//        LinkedList<String>list=new LinkedList<String>();
//        LinkedHashMap<String,Integer> listTest=new LinkedHashMap<>();
//        LinkedList<String> list2 = new LinkedList<String>();
//        for(int i=0;i<dijkstra.length;i++){
//            if(dijkstra[i]>1){
//                list.add(hashReverse.get(i));
//                list2.add(hashReverse.get(i));
//                System.out.print(hashReverse.get(i));
//            }
//        }
