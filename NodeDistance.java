...
public class NodeDistance {
   ...
   public static void main(String[] args) throws Exception {
       ...
       for (int l = 0; l < cases; l++) {
           ...
           BNode<String> fromBNode = tree.find(tree.root, from);
           BNode<String> toBNode = tree.find(tree.root, to);
           if (fromBNode == null || toBNode == null)
               System.out.println("ERROR");
           else {
               BNode<String> lca = tree.LCA(tree.root, fromBNode, toBNode);
               System.out.println((tree.rastojanie(lca, fromBNode) + tree.rastojanie(lca, toBNode)) * 2);
           }
